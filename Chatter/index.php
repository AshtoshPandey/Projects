...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">Chatter</h1>
    <p class="lead font-weight-normal">For those of you who never keep quiet, in reality, or in the virtual world.</p>
    <form method="post" action="claim.php">
      Chatter:<input type="text" name="room"</input>
      <button class="btn btn-outline-secondary" href="#">ClaimRoomAt/</button>
    </form>
  </div>
